...
"""
def main():
    # Determine the shoe types based on the materials provided. create a list
    materials_1 = ["leather", "rubber"]
    materials_2 = ["canvas", "rubber"]
    materials_3 = ["mesh", "rubber"]

    # Use the create_shoe function and check the result. These are shoe dictionaries.
    ...
    print(f"Shoe_2 is of type: {shoe_2['type']}")
    print(f"Shoe_3 is of type: {shoe_3['type']}")
