...
def main():
    ...
    #If none of the above conditions match, set the service as "Unknwon"
    if user_requirement == "file_stroage":
        aws_service = "S3"
    ...
    #Print the recommended AWS service based on the user's requirment
