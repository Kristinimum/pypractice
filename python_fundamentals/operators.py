"""Determine if a shopping list item is eligible for free shipping."""

#Define our main function with def main():
def main():
    """Assignment Operators"""
    #Set item_name, item_price, quantity, discount_rate, and elibigble_items
    item_name = "banana"
    quantity = 5
    discount_rate = 0.1
    ...
    # Calculate subtotal as item_rpice # quantity
    ...
    # used to check if an item is eligible for discount
...
# to call this function we will use our entry point into this script.
if __name__ == "__main__":
    main() # this will call our main function
